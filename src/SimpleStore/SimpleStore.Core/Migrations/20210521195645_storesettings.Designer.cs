...
namespace SimpleStore.Core.Migrations
{
    ...
    [Migration("20210521195645_storesettings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleStore.Core.Entities.Settings.StoreSettings", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SimpleStore.Core.Entities.Settings.StoreSettings", b =>
                {
                    b.HasOne("SimpleStore.Core.Entities.Pictures.Picture", "LogoPicture")
                        .WithOne()
                        .HasForeignKey("SimpleStore.Core.Entities.Settings.StoreSettings", "LogoPictureId");
